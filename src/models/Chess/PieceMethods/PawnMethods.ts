...
export class PawnMethods {
  ...
  static CanPawnEnPassant(
    ...
    if (
      ...
      pawn.cell.x === 3 
      &&
      pawn.cell.board.getCells(pawn.cell.y + 1, 3).piece?.name === PieceNames.PAWN 
      &&
      pawn.cell.board.getCells(pawn.cell.y + 1, 3).piece?.color === Colors.BLACK 
      &&
